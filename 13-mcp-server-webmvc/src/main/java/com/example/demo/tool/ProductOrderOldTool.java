...
@Component
@Slf4j
public class ProductOrderOldTool {
    @Autowired
    private ProductOrderRepository repository;

    @Tool(description = "상품 주문 목록을 알려줍니다")
    String getProductOrders(@ToolParam(description="구매회원") String username) {
    ...
    String cancelProductOrder(@ToolParam(description = "주문번호") String orderNumber, @ToolParam(description="구매회원") String username) {
