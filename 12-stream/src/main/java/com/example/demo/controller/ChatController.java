...
public class ChatController {
    ...
    public Flux<String> getChatResponseChatModel(@RequestParam("message") String message) {
    ...
    public Flux<String> getChatResponse(@RequestParam("message") String message) {
        ...
        // return chatClient.prompt().user(message).stream().content().map(objectMapper::writeValueAsString);
